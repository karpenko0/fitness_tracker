...
export class ProgressPhotoController {
  ...
  @Patch(':id')
  async update(@Request() req, @Param('id') id: string, @Body() dto: UpdateProgressPhotoDto) {
    // Ensure the user owns the progress photo
